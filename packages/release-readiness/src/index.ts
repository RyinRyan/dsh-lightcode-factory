...
import type { WorkflowNodeContext, WorkflowRegistration } from 'lightcode-factory-backend/runtime-types'
...
export const name = 'lightcode-workflow-release-readiness'
export const inject = ['lightcodeFactoryBackend']

/** Register the workflow for exactly this plugin lifecycle. */
export function apply(ctx: Context): void {
  ctx.effect(
    () => ctx.lightcodeFactoryBackend.registerWorkflow(workflow),
    'register release readiness workflow',
  )
}
