...
import type { WorkflowNodeOutput, WorkflowNodeRun, WorkflowRunEvent, WorkflowRunView } from 'lightcode-factory-backend/types'
import type { WorkflowPlatformPanelProps } from './WorkflowPlatformPanel.tsx'
...
function NodeOutput({ node, t }: { node: WorkflowNodeRun; t: WorkflowPlatformPanelProps['t'] }) {
...
function OutputWorkbench({ run, node, t }: { run: WorkflowRunView; node: WorkflowNodeRun; t: WorkflowPlatformPanelProps['t'] }) {
...
export function WorkflowRunOverview({ run, t }: { run: WorkflowRunView; t: WorkflowPlatformPanelProps['t'] }) {
